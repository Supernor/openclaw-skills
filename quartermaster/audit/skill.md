---
name: audit
description: Compare the decision board against recent chat history to find stale, missing, or contradicted decisions. Also audits workspace token efficiency. Usage: /audit
version: 2.0.0
author: relay
...
/audit context          # Token efficiency audit across all agent workspaces
```
...
## Context Audit Mode (`/audit context`)
