...
ALL_SECTIONS="updates learn health ops activity bridge-smoke newidea board design inspect workshop assembly feedback agents systemmap issues pipeline truth settings"
