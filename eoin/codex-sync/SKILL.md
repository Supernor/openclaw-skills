---
name: codex-sync
description: Detect when Codex OAuth is failing and fix it by syncing fresh tokens to the gateway. The #1 most common system issue - tokens expire, gateway falls back to a slower model, everything degrades.
version: 1.0.0
author: eoin
